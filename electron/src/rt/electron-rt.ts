...
// --- Add your menu listeners here ---
ipcRenderer.on("menu-view-drivers", () => {
  window.dispatchEvent(new Event("menu-view-drivers"));
});

ipcRenderer.on("menu-login-new-user", () => {
  window.dispatchEvent(new Event("menu-login-new-user"));
});
// --- End menu listeners ---
